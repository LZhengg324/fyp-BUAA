...
class ThresholdCard:
    def __init__(self, server: Server, source_manager: SourceManager,
        ...
        # List
        self.state.Threshold_value_steps = {}
        ...
        self.state.Threshold_max = 0
        self.state.Threshold_value_step = 0
        self.state.Threshold_min = 0
        ...
        @self.state.change("Threshold_sel_scalar")
        def update_threshold_sel_scalar(Threshold_sel_scalar, **kwargs):
            if self.state.point_data_range[Threshold_sel_scalar]:
                self.state.Threshold_min = self.state.point_data_range[Threshold_sel_scalar][0]
                self.state.Threshold_value_step = self.state.Threshold_value_steps[Threshold_sel_scalar]
                self.state.Threshold_max = self.state.point_data_range[Threshold_sel_scalar][1]
    ...
    # -----------------------------------------------------------------------------
    def show_card(self):
        with UICard(card_type=CardType.Threshold, data_holder=self.data_holder).ui_card():
            with vuetify.VRow(
            ):
    ...
    def default_lower_value(self):
        self.state.Threshold_lower_value = self.state.Threshold_min

    def default_upper_value(self):
        self.state.Threshold_upper_value = self.state.Threshold_max